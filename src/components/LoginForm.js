            ...
            <div className="modal_inner">
                ...
                <Form method='POST'>
                    <div>
                        <div className="email_input_wrapper">
                            <div className="email_input__label_wrapper">
                                ...
                                <span style={{ fontSize: '14px' }}>
                                    ...
                                    <span className="email_input__label_wrapper_span"><Link to='/signup'>Cadastre-se</Link></span>
                                </span>
                            </div>
                            <div>
                        ...
                        <div className="pass_input_wrapper">
                            <div className="pass_input__label_wrapper">
                                ...
                                {/* <span className="pass_input__label_wrapper_span">
                                <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 640 512" className="svg-inline--fa fa-eye fa-w-18">
                    ...
                    <div className="bottom_box">
                        <div className="bottom_box_button_login"><button type='submit' disabled={isSubmitting}><span>{isSubmitting ? 'Processando...' : 'Entrar'}</span></button></div>
                        {/* <div>
                            <div className="cta_bottom_box_divider"><span className="cta_bottom_box_divider_text">OU</span></div>
                            <button type='button' className="button_wrapper_facebook">
                                ...
                                <div className="button_wrapper_facebook_text">Entrar com Facebook</div>
                            </button>
                            <button type='button' className="button_wrapper_google">
                                ...
                                <div className="button_wrapper_google_text">Entrar com Google</div>
                            </button>
                            <button type='button' className="button_wrapper_google">
                                <div>
                                ...
                                <div className="button_wrapper_google_text">Entrar com Apple</div>
                            </button>
                        </div> */}
